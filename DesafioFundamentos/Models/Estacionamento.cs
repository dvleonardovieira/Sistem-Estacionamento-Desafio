...
namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void RemoverVeiculo()
        {
            ...
            if (veiculos.Any(x => x.ToUpper() == RemoverPlaca.ToUpper())) //expressao lambda
            {
                ...
                Console.WriteLine($"O veículo {RemoverPlaca} foi removido e o preço total foi de: ${valorTotal}");
            }
            else
            {
